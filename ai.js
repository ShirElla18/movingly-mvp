...
function getFallbackResponse(userMessage) {
    ...
    if (lowerMessage.includes("אריזה") || lowerMessage.includes("לארוז")) {
        return "מתחילים מהחדרים הכי פחות בשימוש, אורזים קרטון-קרטון לפי חדר ומסמנים כל קרטון בתוכן וביעד. כלים שבירים נעטפים בנפרד ובעמידה. רוצה שאכין לך רשימת אריזה לפי חדרים?";
    }
    if (lowerMessage.includes("עיצוב") || lowerMessage.includes("ארגון")) {
        return "כדאי לתכנן את מיקום הרהיטים עוד לפני ההובלה, להתחיל מאזורים מרכזיים (סלון ומטבח) ולהשאיר פינות אחסון פנויות. אספר לך עקרונות עיצוב מותאמים לדירה החדשה שלך?";
    }
    if (lowerMessage.includes("אפליקציה") || lowerMessage.includes("הכוונה")) {
        return "באפליקציה יש לך לוח תכנון עם המשימות לפי שלבים, מאגר ספקים מותאם, והעוזר האישי שלי לכל שאלה. אפשר גם ללחוץ על הפעמון למעלה כדי לראות תזכורות פעילות. במה להתחיל?";
    }
    if (lowerMessage.includes("שכונה")) {
        return "ספר לי לאיזו שכונה אתה עובר, ואשמח לעזור עם מידע על בתי ספר, פארקים, תחבורה ומקומות בילוי באזור.";
    }
